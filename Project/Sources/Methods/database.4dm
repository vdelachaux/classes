...
If (This:C1470[""]=Null:C1517)
	...
	Else 
		...
		If (Length:C16($t)>0)
			...
			$o.data:=File:C1566($t;fk platform path:K87:2)
			
		Else 
			
			$o.dataless:=True:C214
		...
		$o.root:=Folder:C1567(Folder:C1567(fk database folder:K87:14;*).platformPath;fk platform path:K87:2)
