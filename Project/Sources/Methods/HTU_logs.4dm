...
$o.error("a message displayed on a monitor screen or printout, indicating that an incorrect instruction has been given, or that there is an error resulting from faulty software or hardware.")

$o.verbose:=True:C214  // "verbose" authorizes the logging of information
$o.infos("Hello world")  // This line will not be written

If (Shift down:C543)
	
	$o.open()  // Open the log file
