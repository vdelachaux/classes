...
$subMenu:=menu.append("Sub menu Item 1"; "subitem1").append("Sub menu Item 2"; "subitem2")
...
$menu.append("Fonts"; menu.fonts(True:C214)).line().append("Windows"; menu.windows())

// Append the standard edit menu
$menu.append(":xliff:CommonMenuEdit"; menu.edit())
